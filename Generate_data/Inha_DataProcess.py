...
class Inha_dataProcess:
        ...
        for i in range(len(self.ship_ID)):
            ...
            if index_ship == OS_ID:
                self.ship_dic[OS_ID]= {
                    ...
                    # 'Pos_Y' : self.Pre_Y,
                    'r_deg': self.r_deg[i],
                    'Drift_angle' : self.Drift_angle[i],
                    'u_body' : self.u_body[0][i],
    ...
    def CRI_cal(self, OS, TS):
        ...
        # return RD, RC, TB, RB, Vox, Voy, Vtx, Vty, DCPA, TCPA, UDCPA, UTCPA, UD, UB, UK, enc, Rf, Ra, Rs, Rp, SD_dist, cri_value, rb,lb

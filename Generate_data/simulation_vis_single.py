...
data = pd.read_csv('C:/Users/SMY/Desktop/연구실/11. 데이터/06. 2024 내수면 시험 데이터/시험결과 분석용 데이터 정리/202405301159/common_values.csv')
...
for i in range(data_len):
    ...
    Ct1, rf1, ra1, rs1, rp1, Vx, Vy, C1x, C1y, C2x, C2y, C3x, C3y,
    enc1, cri1_list, Heading_list, time)

    print(i)
    Save_image = aa.ploting(name='C:/Users/SMY/Desktop/연구실/11. 데이터/06. 2024 내수면 시험 데이터/시험결과 분석용 데이터 정리/202405301159/fig/snap%s.png'%str(i))
...
class Visualization:
    ...
    C1x, C1y, C2x, C2y, C3x, C3y, C4x, C4y, C5x, C5y, C6x, C6y, C7x, C7y, C8x, C8y, C9x, C9y, enc1, enc2, enc3, cri1, cri2, cri3, time):
...
for i in range(data_len):
    ...
    aa = Visualization(OS_ship_ID, 2, 0.6, Xo, Xo_list, Yo, Yo_list, Co, Xt1, Xt1_list, Yt1, Yt1_list, Xt2, Xt2_list, Yt2, Yt2_list, Xt3, Xt3_list, Yt3, Yt3_list,
    ...
    C7x, C7y, C8x, C8y, C9x, C9y,
    enc1, enc2, enc3, cri1_list, cri2_list, cri3_list, time)
